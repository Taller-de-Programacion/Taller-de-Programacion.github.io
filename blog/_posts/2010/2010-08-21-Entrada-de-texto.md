...
Haremos una aplicación con interfaz gráfica en GTK 2.0
Agregamos una caja de [entrada de texto](http://library.gnome.org/devel/gtk/stable/GtkEntry.html) y hacemos que al presionar el botón, se imprima el texto ingresado por el usuario por la salida estándar.
